...
import CV from "../../../public/assets/CV-Quentin-Plet.pdf";

const Data = () => {
  return (
    <DataStyled className="home__data">
      ...
      <p className="home__description">
        I'm a web developer based in France. <br />
        I'm passionate about web and audio technologies. <br /> I'm currently
        looking for an apprenticeship as a JavaScript front-end developer.
      </p>
